...
<?php
$this->breadcrumbs = array('Usuarios' => array('index'), 'Nuevo usuario');
...
<div class="form-group">
    ...
    <div class="form-group">
        ...
        <?php echo $form->checkBoxList($user, 'tags', $tags, array('class' => 'form-control')); ?>
...
<!-- Botón de Guardar -->
<div class="form-group">
    <?php echo CHtml::submitButton('Crear Usuario', array('class' => 'btn btn-primary')); ?>
</div>
